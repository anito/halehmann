...
<div class="step-buttons">
	...
	<?php if ( $step->has_prev() ) : ?>
		...
		<a class="prev-step-button step-trigger button alternate" id="prev-step-<?php echo $step->get_id();?>" data-href="<?php echo $step->prev->get_id(); ?>" href="#step-<?php echo $step->prev->get_id(); ?>">
