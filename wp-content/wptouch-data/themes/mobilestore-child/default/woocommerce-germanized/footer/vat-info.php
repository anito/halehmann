...
<?php if ( get_option('woocommerce_gzd_small_enterprise') != 'yes' ) : ?>
	...
	<p class="footer-info sale-info">Copyright &copy; <?php echo date('Y'); ?>&nbsp;<span>HA Lehmann</span><sup>&reg;</sup><br/>
		<span class="">Design by </span><span class="powered-by-webpremiere"><a href="#" target="_blank"><img class="logo" src="https://webpremiere.de/files/public-docs/webpremiere/svg/webpremiere-logo-5.svg" alt="WebPremiere"></a><sup>&reg;</sup></span>
	</p>
<?php else : ?>
