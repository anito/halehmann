...
<p> Army-Shop Lehmann funktioniert wahrscheinlich nicht sonderlich gut mit deinem Browser. Wir unterstützen lediglich jüngere Browser Versionen wie Chrome, Firefox, Safari, und Edge. Benutze diesen hier auf eigenes Risiko! </p>
<p>Falls du der Meinung bist diese Mitteilung sei ein Fehler, <a href="mailto:info@ha-lehmann.at">schreibe uns eine E-Mail an support@ha-lehmann.at</a> und teile uns dein Browser-Model und Version mit.</p>
...
<script>
    ...
    document.getElementById('unsupported-banner').addEventListener('click', function(){
      document.body.className = document.documentElement.className.replace(' hide-unsupport','');
    });
  </script>
</div>
