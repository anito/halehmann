<div class='item-inner'>
    ...
    <input type='submit' name='fix_cat_<?php echo $product->get_id() ?>[submit]' value='<?php echo $button_title ?>' class='fixit'>
    <input type='hidden' name='fix_cat_<?php echo $product->get_id() ?>[product_id]' value='<?php echo $product->get_id() ?>'>
    <input type='hidden' name='fix_cat_<?php echo $product->get_id() ?>[sales_id]' value='<?php echo $sales_id ?>'>
