<div id="unsupported-message">
    ...
    <div id="unsupported-modal" role="alertdialog" aria-labelledby="unsupported-title">
        ...
        <p> Army-Shop Lehmann funktioniert wahrscheinlich nicht sonderlich gut mit Internet Explorer <span id="ie_version"></span>. Wir unterstützen lediglich jüngere Browser Versionen wie Chrome, Firefox, Safari, und Edge. Benutze diesen hier auf eigenes Risiko! </p>
        <p>Falls du der Meinung bist diese Mitteilung sei ein Fehler, <a href="mailto:support@ha-lehmann.at">schreibe uns eine E-Mail an support@ha-lehmann.at</a> und teile uns Modell und Version deines Browsers mit.</p>
