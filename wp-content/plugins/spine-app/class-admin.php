    ...
    public function section_text() {
        ...
        switch($tab) {
            case 'db_backup':
                ...
                break;
            case 'wpt_custom_menu':
                $text = sprintf( __( "Providess a custum menu instead of the default <i>Pages Menu</i> (below the optional product categories menu).</br>Please refer to position <i>WPtouch Pro: Alternate Pages Menu</i> in <a alt='Menü Settings' href='%s'>Menu Settings</a> when selecting your own menu.", "spine-app" ), '/wp-admin/nav-menus.php'  );
                break;
            case 'woo_action_taxonomy':
