    ...
    public function section_text() {
        ...
        switch($tab) {
            case 'db_backup':
                ...
                break;
            case 'wpt_custom_menu':
                $text = sprintf( __( "Provides a custum Menü instead of the default Pages Menu (often below the optional product categories menu).</br>Please refer to <i>WPtouch Pro: Alternate Pages Menu</i> in <a alt='Menü Settings' href='%s'>Menu Settings</a> and select your own menu.", "spine-app" ), '/wp-admin/nav-menus.php'  );
                break;
            case 'woo_action_taxonomy':
