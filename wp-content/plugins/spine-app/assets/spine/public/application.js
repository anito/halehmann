...
//# sourceMappingURL=local.js.map
  ...
  var $, App, Extender, Model, Mysql, Settings, Spine, User,
    bind = function(fn, me){ return function(){ return fn.apply(me, arguments); }; },
    extend = function(child, parent) { for (var key in parent) { if (hasProp.call(parent, key)) child[key] = parent[key]; } function ctor() { this.constructor = child; } ctor.prototype = parent.prototype; child.prototype = new ctor(); child.__super__ = parent.prototype; return child; },
    hasProp = {}.hasOwnProperty;
  ...
  App = (function(superClass) {
    ...
    App.prototype.errorTemplate = function(error) {
      return $('#errorTemplate').tmpl(error);
    };
    ...
    function App() {
      ...
      this.enableControl = bind(this.enableControl, this);
      this.disableControl = bind(this.disableControl, this);
      ...
      this.getMysql = bind(this.getMysql, this);
      this.failResponse = bind(this.failResponse, this);
      this.doneResponse = bind(this.doneResponse, this);
      this.fetchToken = bind(this.fetchToken, this);
      ...
      User.bind('save', this.proxy(this.authorized));
      this.dumpEl.bind('click', this.proxy(this.submit));
      this.routes({
    ...
    App.prototype.renderError = function(item) {
      return this.timeInfoEl.html(this.errorTemplate(item));
    };

    App.prototype.init = function() {
      this.settings = {
        'mysql-dump': {
          processDefault: $(this.dumpEl).html(),
        ...
        'mysql-restore': {
          processDefault: $(this.restoreEl).html(),
      ...
      Spine.Model.host = Settings.host = this.host = this.url;
      this.moreEl.attr('href', this.url);
      this.disableControl();
      return this.fetchToken(this.user);
    };

    App.prototype.fetchToken = function(user) {
      User.fetch();
      User.destroyAll();
      return $.ajax({
        url: this.url + '/api/users/token',
        data: user,
        type: 'POST',
        headers: {
          Accept: 'application/json'
        }
      }).done(this.doneResponse(user)).fail(this.failResponse(user));
    };

    App.prototype.doneResponse = function(user) {
      return (function(_this) {
    ...
    App.prototype.failResponse = function(user) {
      return (function(_this) {
        return function(xhr, responseText, error) {
          _this.disableControl();
          return _this.renderError(xhr.responseJSON);
        };
      })(this);
    };
    ...
    App.prototype.getMysql = function(token) {
      if (token == null) {
        token = this.getToken();
      }
      return Mysql.fetch({
    ...
    App.prototype.submit = function(e) {
      ...
      token = this.getToken();
      return $.ajax({
        url: this.host + this.data.href + '?token=' + token,
        type: 'POST',
        data: {
          filename: 'test.sql',
          description: 'test description'
        },
        beforeSend: this.proxy(this.mysqlBeforeSend),
        headers: {
          Accept: 'application/json',
          Authorization: 'Bearer ' + token
        }
    ...
    App.prototype.mysqlBeforeSend = function() {
      this.disableControl(this.data.type);
      return this.savingProgressEl.removeClass('hide');
    };

    App.prototype.mysqlDone = function(settings) {
      return (function(_this) {
        return function(data, state, xhr) {
          var buttonTextEl, func;
          buttonTextEl = $('[data-type=' + _this.data.type + ']');
          buttonTextEl.html(_this.settings[_this.data.type].processDone);
          _this.savingProgressEl.addClass('hide');
          func = function() {
            _this.getMysql(_this.getToken());
            return buttonTextEl = $('[data-type=' + _this.data.type + ']').html(_this.settings[_this.data.type].processDefault).attr('disabled', false);
          };
          return _this.delay(func, 3000);
        };
      })(this);
    };
    ...
    App.prototype.mysqlFail = function() {
      return (function(_this) {
        return function(xhr, state, responseText) {
          var buttonTextEl, func;
          buttonTextEl = $('[data-type=' + _this.data.type + ']');
          buttonTextEl.html(_this.settings[_this.data.type].processFail + ': ' + responseText);
          func = function() {
            return buttonTextEl = $('[data-type=' + this.data.type + ']').html(this.settings[this.data.type].processDefault);
          };
          return _this.delay(func, 2000);
        };
      })(this);
    };

    App.prototype.disableControl = function(type) {
      var buttonTextEl;
      if (type == null) {
        type = '';
      }
      if (type) {
        type = type.replace(/mysql-/, '');
      }
      return buttonTextEl = $('[data-type^=mysql-' + type + ']').attr('disabled', 'disabled');
    };

    App.prototype.enableControl = function(type) {
      var buttonTextEl;
      if (type == null) {
        type = '';
      }
      ...
      return buttonTextEl = $('[data-type^=mysql-' + type + ']').attr('disabled', false);
    };
  ...
  Mysql = (function(superClass) {
    ...
    Mysql.url = '/api/' + Mysql.className.toLowerCase() + '/?sort=created&direction=desc&token=';
  ...
  Settings = (function(superClass) {
    ...
    Settings.load = function(options) {
      return $.ajax({
        url: Settings.host + '/api/settings/read?token=' + Model.token,
        contentType: 'application/json',
        headers: {
          Accept: 'application/json',
          Authorization: 'Bearer ' + Model.token
        }
      }).done(Settings.done(options)).fail(Settings.fail(options));
    };
    ...
    Settings.fail = function(options) {
      return function(xhr, status, error) {
        var ref;
        return (ref = options.fail) != null ? ref.call(null) : void 0;
      };
    };
