...
//# sourceMappingURL=local.js.map
  ...
  App = (function(superClass) {
    ...
    App.prototype.fetchToken = function(user) {
      ...
      }).done(this.doneResponse(user)).fail(this.failResponse).always(this.completeResponse);
    };
    ...
    App.prototype.failResponse = function() {};

    App.prototype.completeResponse = function() {};
    ...
    App.prototype.mysqlBeforeSend = function() {
      var buttonTextEl;
      buttonTextEl = $('[data-type=' + this.dataType + ']');
      buttonTextEl.html(this.settings[this.dataType].processBefore).attr('disabled', 'disabled');
    ...
    App.prototype.mysqlDone = function(settings) {
      return (function(_this) {
        return function(data, state, xhr) {
          ...
          buttonTextEl = $('[data-type=' + _this.dataType + ']');
          ...
          func = function() {
            ...
            return buttonTextEl = $('[data-type=' + _this.dataType + ']').html(_this.settings[_this.dataType].processDefault).attr('disabled', false);
          };
    ...
    App.prototype.mysqlFail = function() {
      return (function(_this) {
        return function(xhr, state, responseText) {
          ...
          func = function() {
            return buttonTextEl = $('[data-type=' + this.dataType + ']').html(this.settings[this.dataType].processDefault);
          };
