...
class Perfect_Woocommerce_Brands {
	...
	public function enqueue_scripts() {
		...
		wp_register_script(
				'pwb-lib-slick', PWB_PLUGIN . '/assets/lib/slick/slick.min.js', array( 'jquery' ), '1.8.0', true
		);

		wp_register_style(
				'pwb-lib-slick', PWB_PLUGIN . '/assets/lib/slick/slick.css', array(), '1.8.0', 'all'
		);

		wp_enqueue_style(
				'pwb-styles-frontend', PWB_PLUGIN . '/assets/css/styles-frontend.min.css', array(), PWB_PLUGIN_VERSION, 'all'
		);

		wp_enqueue_script(
				'pwb-functions-frontend', PWB_PLUGIN . '/assets/js/functions-frontend.min.js', array( 'jquery' ), PWB_PLUGIN_VERSION, true
		);
	}
